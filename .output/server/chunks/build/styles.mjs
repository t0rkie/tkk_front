...
const styles = {
  ...
  "components/LoadingScreen.vue": () => import('./LoadingScreen-styles.BsqkIoBz.mjs').then(interopDefault),
  "components/LoadingScreen.vue?vue&type=style&index=0&scoped=0d29fa0f&lang.css": () => import('./LoadingScreen-styles.B36nCc4v.mjs').then(interopDefault)
};
